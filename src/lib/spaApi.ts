...
export const spaApi = {
  ...
  setHeater: (on: boolean) => requestSpa('/api/spa/heater', {
    method: 'POST',
    body: JSON.stringify({ on })
  }),
  setFilter: (on: boolean) => requestSpa('/api/spa/filter', {
    method: 'POST',
    body: JSON.stringify({ on })
  }),
  setBubbles: (on: boolean) => requestSpa('/api/spa/bubbles', {
    method: 'POST',
    body: JSON.stringify({ on })
  }),
  setTargetTemperature: (celsius: number) => requestSpa('/api/spa/target-temperature', {
    method: 'POST',
