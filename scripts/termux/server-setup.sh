...
pkg install -y openssh termux-services caddy >/dev/null
...
Next manual steps:
  ...
  6. Optional HTTPS (after choosing a hostname):
       spar https-setup internal spararama.home.arpa
     or see docs/old-phone-server.md for a real-domain certificate.
